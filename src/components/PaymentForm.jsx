...
import SociapaLogo from "../../public/assets/img/mainLogo.png"
...
export default function PaymentForm({ onProceed, amount,data }) {
    ...
    const initializeRazorpay = () => {
        const exchangeRate = 87.2; // Example USD to INR rate, update as needed
        const amountInDollars = parseFloat(data[1].replace('$', '').trim());
